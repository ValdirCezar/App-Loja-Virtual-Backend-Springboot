...
public class DBService {
	...
	public void instantiateTestDatabase() throws ParseException {
		...
		Cliente cli1 = new Cliente(null, "Maria Silva", "valdircezar312@gmail.com", "51794566066",
				TipoCliente.PESSOAFISICA, pe.encode("123"));
		cli1.getTelefones().addAll(Arrays.asList("33235656", "25964878"));

		Cliente cli2 = new Cliente(null, "Enzo Fernandes Goncalves", "enzo@gmail.com", "47916024047",
				TipoCliente.PESSOAFISICA, pe.encode("123"));
